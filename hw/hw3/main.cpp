...
void StudentTests() {
  ...
  //   
    ...
    assert (ja.numElements() == 6);
    assert (ja.numElementsInBin(0) == 0);
    assert (ja.numElementsInBin(1) == 1);
    assert (ja.numElementsInBin(2) == 2);
    assert (ja.numElementsInBin(3) == 1);
    assert (ja.numElementsInBin(4) == 2);
    assert (ja.getElement(1,0) == 2);
    assert (ja.getElement(2,0) == 3);
    assert (ja.getElement(2,1) == 8);
    assert (ja.getElement(3,0) == 5);
    assert (ja.getElement(4,0) == 3);
    assert (ja.getElement(4,1) == 1);
    ...
    assert (ja.numBins() == 5);
    assert (ja.numElements() == 7);
    assert (ja.numElementsInBin(0) == 1);
    assert (ja.numElementsInBin(1) == 1);
    assert (ja.numElementsInBin(2) == 2);
    assert (ja.numElementsInBin(3) == 1);
    assert (ja.numElementsInBin(4) == 2);
    ...
    assert (ja.getElement(4,0) == 3);
    assert (ja.getElement(4,1) == 1);
    assert (ja.getElement(0,0) == 8);

    // remove '1' and verify
    ja.removeElement(4,1);
    ...
    assert (ja.numElementsInBin(2) == 2);
    assert (ja.numElementsInBin(3) == 1);
    assert (ja.numElementsInBin(4) == 1);
    assert (ja.getElement(1,0) == 2);
    assert (ja.getElement(2,0) == 3);
    assert (ja.getElement(2,1) == 8);
    assert (ja.getElement(3,0) == 5);
