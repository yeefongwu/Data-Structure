...
int main() {
  ...
  // ADD MORE TEST CASES HERE
    remove_matching_elements(z, 10.0000000);
    cout << "New contents: ";
    ...
    a.push_back(55);
    a.push_back(22);
    cout << "Contents of vector a: ";
    for (int i = 0; i < a.size(); ++i)
    {
        cout << a[i] << " ";
    }
    cout << endl;
    remove_matching_elements(a, 11);
    cout << "New contents: ";
    for (int i = 0; i < a.size(); ++i)
    {
        cout << a[i] << " ";
    ...
    cout << endl;
    //Order notation for remove_matching_elements: O(n*e) because there is one
    //  for loop in the actual function so n, and then it may call erase() which has
    //   another for loop so e*n
    ...
    //z.print();
    // ------------------------
    // test push_back() and number of re-allocations for m_data
    a.clear();
